...
export const sendMail =(userData:any, userType:string , token : string )=>{
        ...
        <body class="bg-gray-100 font-sans">
            <div class="max-w-screen-md mx-auto p-6">
                ...
                <div class="bg-white p-6 border rounded mt-4">
                    ...
                    <p class="mt-4"><a href="https://think-craft-asgyb0zvn-arshadvk.vercel.app${userType}/set-password/${token}" class="text-blue-500 text-shadow font-bold text-3xl">Complete Your Registration</a></p>
