...
const createToken = (admin) => {
    ...
    if (!secretKey)
        throw new error_js_1.AppError("JWT secret key is not defiend", 401);
    console.log(secretKey);
    const token = jsonwebtoken_1.default.sign({ admin, role: "admin" }, secretKey, { expiresIn: "1day" });
    return token;
};
exports.createToken = createToken;
exports.adminLoginValidate = (0, exports.adminLogin)(hashing_js_1.isPasswordCorrect, exports.createToken);
